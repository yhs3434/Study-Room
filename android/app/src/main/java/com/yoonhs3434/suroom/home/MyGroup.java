...
public class MyGroup extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        recyclerView = (RecyclerView) view.findViewById(R.id.myGroupRecyclerView);
    ...
    public void setUserVisibleHint(boolean isVisibleToUser) {
        ...
        if(isVisibleToUser){
            ...
            params[0] = MySetting.getMyUrl()+"group/u/"+MySetting.getMyId()+"/";
    ...
    private class MyAdapter extends RecyclerView.Adapter<MyGroup.MyAdapter.ViewHolder>{
        ...
        @Override
        public MyGroup.MyAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int i) {
            View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_item_group, parent, false);
            MyGroup.MyAdapter.ViewHolder holder = new MyGroup.MyAdapter.ViewHolder(v);
            return holder;
        }

        @Override
        public void onBindViewHolder(@NonNull MyGroup.MyAdapter.ViewHolder holder, final int i) {
            ...
            holder.itemView.setOnClickListener(new View.OnClickListener(){
                ...
                public void onClick(View v){
                    ...
                    Intent intent = new Intent(context, GroupRoom.class);
